...
latitude_avg, latitude_std = calculate_average_and_std(latitudes[200:])
longitude_avg, longitude_std = calculate_average_and_std(longitudes[200:])
...
plt.figure(figsize=(10, 6))
plt.scatter(latitudes_adjusted[200:], longitudes_adjusted[200:], label='Data Points')
