                ...
                with self.lock_send:
                    if not self.transmit_queue.empty():
                        ...
                        if data:
                            ...
                            # self.serial_port.write("mode:AUTO,PWML:1422,PWMR:1424".encode('UTF-8'))
...
if __name__ == "__main__":
    ...
    current_value = {
        ...
        'dest_latitude': None, 'dest_longitude': None, 'mode_pc_command': "AUTO", 'com_status_send': False, 'com_status_recv': False, # pc get params
        'mode_chk': "SELF", 'pwml_chk': None, 'pwmr_chk': None, # nucleo get params
        'pwml_auto': 50, 'pwmr_auto': 2001, 'pwml_sim': None, 'pwmr_sim': None, 'cnt_destination' : None, 'distance': None, "waypoint_latitude" : None, "waypoint_longitude" : None, # auto drving
    ...
    try:
        ...
        serial_nucleo_cpy = serial_nucleo("/dev/pts/5")
