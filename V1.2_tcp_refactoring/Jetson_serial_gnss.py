...
class serial_gnss:
    ...
    def _process_gnrmc_data(self, tokens):
        try:
            ...
            self.flag_gnss = True # _process_gnrmc_data valid or not
...
if __name__ == "__main__":
    ...
    try:
        # serial_cpy = serial_gnss("/dev/ttyACM0") # origin name
        # serial_cpy = serial_gnss("/dev/septentrio2", gnss_lock, 1) # tty fixed name
