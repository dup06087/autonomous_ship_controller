        ...
        try:
            ...
            if not flag_ready_to_auto_drive: # not ready                   
                ...
                if self.flag_avoidance:
                    ...
                    calculate_pwm_auto(self, current_latitude,current_longitude,float(self.current_value['dest_latitude'][self.cnt_destination]),float(self.current_value['dest_longitude'][self.cnt_destination]),current_heading)
...
def calculate_vff_force(self, obstacles):
    ...
    for obs in obstacles:
        ...
        force_magnitude = 1 / (distance * 0.5) **2
