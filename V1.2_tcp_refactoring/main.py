...
class boat:
    ...
    def flag_check_for_autodrive(self):
        ...
        flag_autodrive = flag_devices and flag_data[0]
        # print("flag1 : ", flag_devices, ", flag_data : ", flag_data, ", flag_autodrive : ", flag_autodrive)
        flag_output = [flag_autodrive, flag_data[1], flag_data[2], flag_data[3], flag_data[4], flag_data[5]]
        return flag_output
    ...
    def thread_start(self):
        ...
        while True:
            ...
            if time_ - time_prev >= 3:
                ...
                try:
                    print(self.flag_check_for_autodrive())
                except:
                    pass
