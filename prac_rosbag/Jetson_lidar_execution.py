...
class LidarProcessor:
    def __init__(self):
        ...
        print("initialized")
        rospy.Subscriber("/velodyne_points", PointCloud2, self.callback, queue_size=1000, tcp_nodelay=True)
        print("velodyne points subscribed")
        self.pub = rospy.Publisher('/o3d_pointcloud', PointCloud2, queue_size=1000, tcp_nodelay=True)
        print("o3d_pointcloud published")
        self.marker_tracker_pub = rospy.Publisher('tracker_bounding_boxes', MarkerArray, queue_size=1000, tcp_nodelay=True)
        print("TRACKER published")
    ...
    def callback(self, pointcloud2_msg):
        ...
        try:
            ...
            '''have to erase this part when playing rosbag file'''
