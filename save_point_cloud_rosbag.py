...
class PointCloud2Bag:
    def __init__(self, topic, folder_path):
        self.topic = topic
        self.start_time = datetime.now()  # 시작 시간 기록
        self.folder_path = folder_path
        self.ensure_folder_exists(folder_path)
        self.bag_file_name = self.generate_bag_filename(self.start_time, folder_path)
...
if __name__ == '__main__':
    ...
    folder_path = 'pointcloud_data'  # 저장할 폴더 이름

    pc2_bag = PointCloud2Bag(topic_name, folder_path)
