...
if __name__ == "__main__":
    ...
    # try:
        # serial_cpy = serial_gnss("/dev/ttyACM0",None,None) # origin name
    serial_cpy = serial_gnss("/dev/ttyACM0", gnss_lock, 1, 0) # tty fixed name
